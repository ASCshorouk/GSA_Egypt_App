...
public class Alexmap extends Activity{
...
public void CheckConnection() {
	...
	if (wifi.isAvailable()
		...
		Intent i = new Intent(Alexmap.this, No_Internet.class);
		startActivity(i);
		...
		**/
		...
		Load();
		  ...
		  // webView.loadUrl("http://maps.google.com/maps?z=17&t=h&q=loc:30.051451,31.345840");
		   webView.loadUrl("https://www.google.com/maps/place/Alexandria+University+Administration/@31.19952,29.916741,15z/data=!4m5!1m2!2m1!1salexandria+university!3m1!1s0x14f5c47655b4d509:0x8979082f5f3aaa50");
