...
public class Nilemap extends Activity{
...
public void CheckConnection() {
	...
	if (wifi.isAvailable()
		...
		Intent i = new Intent(Nilemap.this, No_Internet.class);
		startActivity(i);
		...
		**/
		...
		Load();
		  ...
		  // webView.loadUrl("http://maps.google.com/maps?z=17&t=h&q=loc:30.051451,31.345840");
		   webView.loadUrl("https://www.google.com/maps/place/Nile+Academy+For+Science/@31.0413861,31.3828396,11z/data=!4m5!1m2!2m1!1sNile+Academy+For+Science,+Mansoura+Qism+2,+Mansoura,+Daqahlia,+Egypt!3m1!1s0x14f79dc20388fc43:0x36cde611e76344ba");
