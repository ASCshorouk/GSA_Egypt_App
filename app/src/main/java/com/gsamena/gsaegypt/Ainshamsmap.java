...
public class Ainshamsmap extends Activity{
	...
	String mapPath = "http://maps.google.com/maps";
	 ...
	 public void CheckConnection() {
			...
			if (wifi.isAvailable()
				...
				Intent i = new Intent(Ainshamsmap.this, No_Internet.class);
				startActivity(i);
			...
			**/
			...
			Load();
			  ...
			  // webView.loadUrl("http://maps.google.com/maps?z=17&t=h&q=loc:30.051451,31.345840");
			   webView.loadUrl("https://www.google.com/maps/place/Ain+Shams+University/@30.0767862,31.2840736,17z/data=!3m1!4b1!4m2!3m1!1s0x14583f9d24b2294b:0x30c182286fafbffa");
