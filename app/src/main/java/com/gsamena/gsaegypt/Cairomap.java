...
public class Cairomap extends Activity {
...
public void CheckConnection() {
	...
	if (wifi.isAvailable()
		...
		Intent i = new Intent(Cairomap.this, No_Internet.class);
		startActivity(i);
		...
		**/
		...
		Load();
		  ...
		  // webView.loadUrl("http://maps.google.com/maps?z=17&t=h&q=loc:30.051451,31.345840");
		   webView.loadUrl("https://www.google.com/maps/place/Cairo+University/@30.0219055,31.2066221,15z/data=!3m1!4b1!4m2!3m1!1s0x145846db01520851:0xbd9781bf40115c5d");
