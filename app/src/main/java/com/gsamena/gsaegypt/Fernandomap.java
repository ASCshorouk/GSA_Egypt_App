...
public class Fernandomap extends Activity{
...
public void CheckConnection() {
	...
	if (wifi.isAvailable()
		...
		Intent i = new Intent(Fernandomap.this, No_Internet.class);
		startActivity(i);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shoroukmap);
		...
		**/
		...
		Load();
		  ...
		  // webView.loadUrl("http://maps.google.com/maps?z=17&t=h&q=loc:30.051451,31.345840");
		   webView.loadUrl("https://www.google.com/maps/place/MET+-+Misr+Higher+Institute+For+Engineering+%26+Technology/@31.0159106,31.3786376,17z/data=!3m1!4b1!4m2!3m1!1s0x14f79db9d4d56311:0x48f1bbafd31ee289");
