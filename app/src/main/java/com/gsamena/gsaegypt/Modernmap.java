...
public class Modernmap extends Activity{
...
public void CheckConnection() {
	...
	if (wifi.isAvailable()
		...
		Intent i = new Intent(Modernmap.this, No_Internet.class);
		startActivity(i);
		...
		**/
		...
		Load();
		  ...
		  // webView.loadUrl("http://maps.google.com/maps?z=17&t=h&q=loc:30.051451,31.345840");
		   webView.loadUrl("https://www.google.com/maps/place/Modern+Academy/@29.9914191,31.3025453,17z/data=!3m1!4b1!4m2!3m1!1s0x145838e6cc85056f:0x78a27bcc2e953c72");
