...
public class Googleforeducation extends Activity {
    ...
    public void CheckConnection(){
        ...
        else
        {
            ...
            Intent i = new Intent(Googleforeducation.this,No_Internet.class);
            startActivity(i);
            finish();
			...
			**/
			...
			Load();
			  ...
			  // webView.loadUrl("http://maps.google.com/maps?z=17&t=h&q=loc:30.051451,31.345840");
			   webView.loadUrl("http://www.google.com/edu/index.html");
