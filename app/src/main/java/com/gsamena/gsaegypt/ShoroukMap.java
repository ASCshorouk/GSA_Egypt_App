...
public class ShoroukMap extends Activity {
 ...
 public void CheckConnection() {
		...
		if (wifi.isAvailable()
			...
			Intent i = new Intent(ShoroukMap.this, No_Internet.class);
			startActivity(i);
		...
		**/
		...
		Load();
		  ...
		  // webView.loadUrl("http://maps.google.com/maps?z=17&t=h&q=loc:30.051451,31.345840");
		   webView.loadUrl("https://www.google.com/maps/place/El+Shorouk+Academy/@30.1194985,31.6065788,17z/data=!4m2!3m1!1s0x0:0xd14c3ac0d3a45d54");
