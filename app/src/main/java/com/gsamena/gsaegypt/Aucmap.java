...
public class Aucmap extends Activity{
...
public void CheckConnection() {
	...
	if (wifi.isAvailable()
		...
		Intent i = new Intent(Aucmap.this, No_Internet.class);
		startActivity(i);
		...
		**/
		...
		Load();
		  ...
		  // webView.loadUrl("http://maps.google.com/maps?z=17&t=h&q=loc:30.051451,31.345840");
		   webView.loadUrl("https://www.google.com/maps/place/American+University+Cairo/@30.0599153,31.2620199,12z/data=!4m5!1m2!2m1!1sAmerican+University+in+Cairo,+Cairo+Governorate,+Egypt!3m1!1s0x14584071bf6f4eb1:0x45a7e37bd42c0238");
